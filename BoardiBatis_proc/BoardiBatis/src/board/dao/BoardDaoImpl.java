...
public class BoardDaoImpl implements IBoardDao{
	...
	@Override
	public boolean checkBoard(SqlMapClient smc, Integer boardNo) throws SQLException {
		boolean chk = false;
	...
	@Override
	public int deleteBoard(SqlMapClient smc, Integer boardNo) throws SQLException {
